        ...
        <section className="rounded-3xl border border-[#dbe5f3] bg-white p-6 shadow-[0_14px_36px_rgba(35,79,132,0.12)] md:p-7">
          ...
          {activeTab === 'vacancies' && (
            <>
              ...
              <div className="mt-5 grid max-h-[calc(100vh-300px)] gap-5 overflow-y-auto pr-2 custom-scrollbar md:grid-cols-2">
                {filteredVacancies.map((vacancy) => {
                  ...
                  return (
                    <article
                      key={vacancy.id}
                      className="group relative overflow-hidden rounded-3xl border border-[#dbe5f3] bg-white p-5 shadow-[0_10px_28px_rgba(32,69,113,.08)] transition-all duration-300 hover:-translate-y-1 hover:border-primary/35 hover:shadow-[0_18px_34px_rgba(32,69,113,.14)]"
                    >
