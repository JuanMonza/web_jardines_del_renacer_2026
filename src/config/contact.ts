...
export const CONTACT_INFO = {
  ...
  whatsappMessage:
    'Hola, quiero recibir información sobre los servicios de Jardines del Renacer.',
  deathReportLine: {
    label: 'Reportar fallecimiento',
    number: '311 390 6052',
    href: 'tel:+573113906052',
    detail: 'Atención inmediata 24/7',
  },
  primaryLine: {
    label: 'Línea principal',
    number: '311 390 6052',
    href: 'tel:+573113906052',
    detail: 'Atención 24/7',
  },
  regionalLines: [
    {
      label: 'Antioquia y Medellín',
      number: '(604) 431 0645',
    ...
    {
      label: 'Bogotá, Cundinamarca y Tolima',
      number: '(601) 794 8497',
      href: 'tel:+576017948497',
    },
  ] satisfies ContactLine[],
  supportHours: 'Atención 24 horas',
