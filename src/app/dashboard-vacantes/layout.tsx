...
const navigation = [
  ...
  {
    href: "/dashboard-vacantes/historial-vacantes",
    label: "Historial vacantes",
    icon: Archive,
  },
  {
...
export default function DashboardVacantesLayout({
  ...
  return (
    <AdminGlassShell
      loginPath="/login/admin-vacantes"
      workspace="Talento humano"
      navigation={navigation}
      requiredPermission="dashboard.vacantes.view"
    >
      {children}
    </AdminGlassShell>
  );
