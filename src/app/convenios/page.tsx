...
const agreements: Agreement[] = [
  ...
  { id: 'nequi', name: 'Nequi', channel: 'online', logo: '/images/flayers/logos-convenios/13_nequi_sin_fondo.png', description: 'Realiza el pago a la cuenta Nequi registrada a nombre de Adriana Ospina Ocampo.', referenceLabel: 'Cuenta Nequi', referenceValue: '3225168832' },
