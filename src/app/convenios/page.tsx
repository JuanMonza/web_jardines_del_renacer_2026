              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="mt-6 rounded-2xl border border-primary/10 bg-white/70 p-4">
                  ...
                  <ol className="mt-3 space-y-3 text-sm leading-5 text-textLight">
                    ...
                    <li className="flex gap-3"><span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-primary text-xs font-bold text-white">3</span>Envía el comprobante por WhatsApp al 311 390 6052 para validar tu pago.</li>
                  </ol>
                </div>
