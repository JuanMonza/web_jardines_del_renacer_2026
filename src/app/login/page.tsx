          ...
          <div className="max-w-md mx-auto relative z-10">
            ...
            <div className="glass border-2 border-primary/20 p-8 rounded-3xl shadow-2xl backdrop-blur-xl relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="group">
                  <label htmlFor="cedula" className="block text-sm font-semibold text-text mb-3 flex items-center gap-2">
                ...
                <div className="group">
                  <label htmlFor="password" className="block text-sm font-semibold text-text mb-3 flex items-center gap-2">
                    <svg className="w-4 h-4 text-primary" fill="currentColor" viewBox="0 0 20 20">
