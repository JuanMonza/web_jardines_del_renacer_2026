...
const modules: Module[] = [
  { title: 'Administración general', role: 'Administrador General', description: 'Gobierno del sitio, usuarios y operación transversal.', icon: ShieldCheck, tone: 'bg-[#e5efff] text-[#315fa8]', href: '/dashboard' },
  ...
  { title: 'Mercadeo', role: 'Administrador de Sorteos', description: 'Incentivos, participantes, sorteos y publicación de ganadores.', icon: BadgeCheck, tone: 'bg-[#fff0d6] text-[#a86708]', href: '/dashboard-sorteos', permission: 'dashboard.sorteos.view' },
...
export default function DashboardPage() {
  ...
  return <div className="p-5 md:p-8">
    <TrainingHint text="Centro de control reúne todos los módulos. Gestionar usuarios permite revisar cuentas, roles y permisos ficticios del ambiente." className="block">
