...
export default function DashboardUsuariosPage() {
  ...
  return <div className="p-5 md:p-8">
    <TrainingHint text="Descargar administradores genera un Excel sin contraseñas. Nuevo administrador crea una cuenta ficticia y asigna su rol principal." className="block">
