...
export default function RootLayout({
  ...
  const isTraining = process.env.APP_ENV === 'training' || process.env.NEXT_PUBLIC_APP_ENV === 'training';
  return (
    <html lang="es" className={`${montserrat.variable}`}>
      <head>
        {!isTraining && <Script id="google-tag-manager" strategy="afterInteractive">
